...
namespace TagDataTranslation.AndroidNative;

/// <summary>
/// C-callable exports for the TDT engine.
/// These are exposed as native symbols in the compiled shared library,
/// callable from any language via the C FFI (including Dart via dart:ffi).
/// </summary>
