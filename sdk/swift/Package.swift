...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/dannyhaak/TagDataTranslation/releases/download/v3.0.3/TagDataTranslation.xcframework.zip",
            checksum: "b8c65348e132ce1a364002faba4dbcd821576840e45b4c1a90a5757b05a37fbb"
        )
    ]
)
