...
Translate an EPC between encoding levels. Output formats: `BINARY`, `TAG_ENCODING`, `PURE_IDENTITY`, `BARE_IDENTIFIER`, `GS1_DIGITAL_LINK`, `GS1_AI_JSON`, `TEI`. Legacy alias `LEGACY` is also accepted.
